...
// Widget class
class PixFlow_Facebook_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'Px_Facebook', // Base ID
            'Px - Facebook Widget', // Name
            array( 'description' => __( 'Widget that displays Facebook Like Box', TEXTDOMAIN ) ) // Args
        );
    }
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id( 'page_url' )); ?>"><?php _e('Facebook Page URL :', TEXTDOMAIN) ?> <small"> Example: http://www.facebook.com/envato </small"></small>
            <input type="text" class="widefat" id="<?php echo esc_url($this->get_field_id( 'page_url' )); ?>" name="<?php echo esc_url($this->get_field_name( 'page_url' )); ?>" value="<?php echo esc_url( $instance['page_url'] ); ?>" />
        </p>
       
        <!-- Show Faces  : Check Box -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'show_faces' )); ?>"><?php _e('Show Faces:', TEXTDOMAIN) ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'show_stream' )); ?>"><?php _e('Show Stream:', TEXTDOMAIN) ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'width' )); ?>"><?php _e('like box width:', TEXTDOMAIN) ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'height' )); ?>"><?php _e('Like box height :', TEXTDOMAIN) ?></label>
...
// register widget
add_action( 'widgets_init', create_function( '', 'register_widget( "PixFlow_Facebook_Widget" );' ) );