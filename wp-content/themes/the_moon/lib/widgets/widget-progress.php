...
class PixFlow_Progress_Widget extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        for($i=1; $i<=5; $i++)
        {
            ...
            <div class="progressbar">   
                ...
                <div class="progress"><div class="progress-inner" style="width:<?php echo esc_attr($instance[$progId]); ?>%"></div></div>
            </div>
            <?php
        }
        ?>
    ...
    function form( $instance ) {
        ...
        <p>
            <?php $id="title$i"; ?>
            <label for="<?php echo esc_attr($this->get_field_id( $id )); ?>"><?php printf(__('Progress %d Title:', TEXTDOMAIN), $i); ?></label>
        ...
        <p>
            <?php $id="progress$i"; ?>
            <label for="<?php echo esc_attr($this->get_field_id( $id )); ?>"><?php printf(__('Progress %d:', TEXTDOMAIN), $i); ?></label>
