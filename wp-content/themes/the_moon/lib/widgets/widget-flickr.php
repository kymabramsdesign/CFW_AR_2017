...
class PixFlow_Flickr_Widget extends WP_Widget {
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'flickrID' )); ?>"><?php _e('Flickr ID:', TEXTDOMAIN) ?> (<a href="http://idgettr.com/">idGettr</a>)</label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'postcount' )); ?>"><?php _e('Number of Photos:', TEXTDOMAIN) ?></label>
        ...
        <!-- Type: Select Box -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'type' )); ?>"><?php _e('Type (user or group):', TEXTDOMAIN) ?></label>
        ...
        <!-- Display: Select Box -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'display' )); ?>"><?php _e('Display (random or latest):', TEXTDOMAIN) ?></label>
